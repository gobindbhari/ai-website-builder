...
const Page = () => {
    ...
    async function init() {
        ...
        const response = JSON.parse(templateResponse!) || await axios.post(`/api/template`, {
            // msg: prompt.trim()
        ...
        setLoading(true);
        const stepsResponse = JSON.parse(chatResponse!) || await axios.post(`/api/chat`, {
                ...
                <div className="h-full flex gap-2 px-2">
                    <div className="w-full max-w-[27vw] space-y-6 overflow-auto scrollbar-none">
                        <div className='max-h-[71vh]'>
                            <ScrollArea className="min-h-[50vh] h-full lg:max-h-[71vh]  overflow-y-scroll scrollbar-none">
                                <StepsList
                                    // steps={steps}
                                    steps={chatHistory}
                    ...
                    <div className="flex w-full max-w-[65vw] bg-gray-900/40">
                        {activeTab === 'code' ? (<>
                            <ScrollArea className="h-[87vh] min-w-60 border-r">
                                <FileExplorer
